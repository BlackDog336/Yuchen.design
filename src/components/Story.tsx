          ...
          <div className="flex flex-row flex-wrap gap-6 lg:w-[200px] lg:shrink-0 lg:flex-col lg:justify-between lg:gap-10 lg:pt-2">
            ...
            <div className="flex flex-col gap-2">
              {["Snowboarding", "Surfing", "Traveling", "City Walking", "Space Aesthetics"].map((hobby) => (
                <span key={hobby} className="inline-flex items-center gap-2 font-sans text-[16px] leading-[1.6] tracking-[-0.16px] text-white/40">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" className="shrink-0">
